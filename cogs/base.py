...
pages = {
    ...
    'General Settings/Commands': (
        ...
        "custom prefixes, and you can enable/disable"
        "QuickActions. More info on the Utility page.\n\n"
        ...
        "**sb!qa:**\nView whether or not QuickActions "
        "are enabled/disabled for the current server.\n\n"
        "**sb!qa on:**\nEnables QuickActions\n\n"
        "**sb!qa off:**\nDisables QuickActions\n\n"
    ),
    'Starboard Commands': (
    ...
    'Utility Commands': (
        "This page includes info on message moderation "
        "commands, QuickActions, and database cleaning. "
        "\nNote that for each of the QuickActions (where "
        "you react to a message with an emoji to do something "
        "instead of running the command), it can't be a "
        "starboard emoji and QuickActions must be turned on "
        "(`sb!qa on`).\n\n"
        "**sb!force <message id> [channel]**\n"
        "Sends a message to all starboards, regardless "
        "of the number of stars it actually has. "
        "You can also react to the message with "
        ":lock:\n\n"
        "**sb!unforce <message id> [channel]**\n"
        "Unforces a message, can also be unforced "
        "with :lock:\n\n"
        "**sb!trash <message id> [channel]**\n"
        "Trashes a message to hide it's content and prevent "
        "it from appearing on starboards. "
        "You can also trash messages by reacting to them "
        "with :wastebasket:\n\n"
        "**sb!untrash <message id> [channel]**\n"
        "Untrashes a message. You can also untrash "
        "by reacting to the message with :wastebasket:\n\n"
        "**sb!freeze <message id> [channel]**\n"
        "Prevents a message from loosing or gaining "
        "reactions. You can also unfreeze by reacting "
        "with :snowflake:\n\n"
        "**sb!unfreeze <message id> [channel]**\n"
        "Unfreezes a message. You can also unfreeze by "
        "reacting with :snowflake:\n\n"
        "**sb!frozen**\nView a list of frozen messages\n\n"
        "**sb!clean**\nIf you are seeing #deleted-channel "
        "or @deleted-role, you can run this command to remove "
        "them from the database."
    ),
    'Role Awards': (
        "There are two types of Role Awards: XP "
        "Roles and Position Roles. (note that "
        "currently both are premium-only)\n\n"
        "**__XP Roles__**\nThese work the way "
        "all other bots with role-awards do it. "
        "Once a user reaches a specified XP, they "
        "receive the role.\n\n"
        "**sb!xpr**\nView current XP Roles\n\n"
        "**sb!xpr add <role> <required xp>**\n"
        "Adds an XP Role\n\n"
        "**sb!xpr remove <role>**\nRemoves an XP Role\n\n"
        "**sb!xpr set <role> <required xp>**\n"
        "Sets the required xp for an already "
        "existing role award.\n\n"
        "**__Position Roles__**\nBasically, each "
        "role has a max-user setting. Then, that "
        "users from the top of the leaderboard "
        "will receive that role -- if you need help "
        "understanding, mention me for a link "
        "to the support server.\n\n"
        "**sb!pr**\nLists current Position Roles\n\n"
        "**sb!pr add <role> <max users>**\nAdds a "
        "Position Role\n\n"
        "**sb!pr remove <role>**\nRemoves a "
        "Position Role\n\n"
        "**sb!pr set <role> <max users>**\nSets "
        "the max users for an already existing "
        "Position Role."
    ),
    'Starboard Premium': (
